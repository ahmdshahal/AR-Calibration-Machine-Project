...
//[ExecuteAlways]
public class ComponentLabelWithPopup : MonoBehaviour
{
    [Header("Data")]
    public ComponentLabelDetailData data;
    ...
    void Start()
    {
        ...
        // Setup tap handler di label card
    ...
    {
        if (data != null)
            ComponentDetailPopup.Instance?.Show(data);
    }
